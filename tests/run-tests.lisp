...
(defparameter *known-failures*
  '(;; (test-tokenizer)
    ...
    "Skip test test3 DATA-STATE: <!----!a-->"
    "Skip test test3 DATA-STATE: <!----!-->"
    "Skip test domjs CDATA-SECTION-STATE: NUL in CDATA section"
    "Skip test domjs RCDATA-STATE: leading U+FEFF must pass through"
    "Skip test domjs RAWTEXT-STATE: leading U+FEFF must pass through"
    "Skip test domjs SCRIPT-DATA-STATE: leading U+FEFF must pass through"
    "Skip test domjs CDATA-SECTION-STATE: CDATA with extra bracket"
    "Skip test domjs CDATA-SECTION-STATE: CDATA without end marker"
    "Skip test domjs CDATA-SECTION-STATE: CDATA with single bracket ending"
    "Skip test domjs CDATA-SECTION-STATE: CDATA with two brackets ending"
    "Skip test test3 CDATA-SECTION-STATE: [empty]"
    ...
    "Skip test test3 CDATA-SECTION-STATE: ."
    "Skip test test3 CDATA-SECTION-STATE: /"
    "Skip test test3 CDATA-SECTION-STATE: 0"
    "Skip test test3 CDATA-SECTION-STATE: 1"
    "Skip test test3 CDATA-SECTION-STATE: 9"
    "Skip test test3 CDATA-SECTION-STATE: ;"
    "Skip test test3 CDATA-SECTION-STATE: ;="
    "Skip test test3 CDATA-SECTION-STATE: ;>"
    "Skip test test3 CDATA-SECTION-STATE: ;?"
    "Skip test test3 CDATA-SECTION-STATE: ;@"
    "Skip test test3 CDATA-SECTION-STATE: ;A"
    "Skip test test3 CDATA-SECTION-STATE: ;B"
    "Skip test test3 CDATA-SECTION-STATE: ;Y"
    "Skip test test3 CDATA-SECTION-STATE: ;Z"
    "Skip test test3 CDATA-SECTION-STATE: ;`"
    "Skip test test3 CDATA-SECTION-STATE: ;a"
    "Skip test test3 CDATA-SECTION-STATE: ;b"
    "Skip test test3 CDATA-SECTION-STATE: ;y"
