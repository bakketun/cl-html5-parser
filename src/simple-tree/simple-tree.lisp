...
(in-package #:html5-parser/simple-tree)
...
(defgeneric element-remove-attribute (element qualifed-name))
(defgeneric element-remove-attribute-ns (element namespace local-name))
(defgeneric element-has-attribute (element qualifed-name))
(defgeneric element-has-attribute-ns (element namespace local-name))
